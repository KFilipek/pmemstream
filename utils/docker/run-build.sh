...
function tests_package() {
	...
	echo "C++ example for timestamp based sorting:"
	compile_example_standalone 05_timestamp_based_order
	run_binary_standalone 05_timestamp_based_order ${WORKDIR}/build/testfile
